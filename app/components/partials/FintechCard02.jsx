...
function FintechCard02({data, ticker, rating}) {

    const data2 = data.map(x => x * rating)
  ...
  const chartData = {
    ...
    datasets: [
      ...
      },
      {
        label: 'Mosaic Portfolio',
        data: data2,
        borderColor: 'rgba(252, 40, 3)',
        fill: true,
        backgroundColor: 'rgba(252, 40, 3, 0.08)',
        borderWidth: 2,
        tension: 0,
        pointRadius: 0,
        pointHoverRadius: 3,
        pointBackgroundColor: 'rgba(252, 40, 3, 0.08)',
        clip: 20,
      },
    ],
  };
